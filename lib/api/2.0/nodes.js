...
// GET /nodes/:identifier/templates/:templateName
var nodesGetTemplatesByName = controller(function(req, res) {
    ...
    .then(function(workflow) {
        ...
        return Promise.all([
            ...
            taskProtocol.requestProperties(nodeId)
        ]);
    })
    .spread(function(options, properties) {
        return templates.render(
            req.swagger.params.templateName.value,
...
module.exports = {
    ...
    nodesGetTemplatesByName: nodesGetTemplatesByName,
    nodesGetTemplatesHeadByName: nodesGetTemplatesByName
};
